  ...
  return (
    <div style={{ boxShadow: "1px 1px 6px rgba(0,0,0,0.15)" }} className='w-[250px] h-[200px] bg-[white] rounded-lg p-2 relative'>
      ...
      <div className='flex absolute top-[50%] translate-y-[-50%]'>
        ...
        <BsArrowDownShort style={sales > 0 ? { color: "#3aff3a",rotate:"180deg" } : { color: "red" }} className='text-3xl place-self-end font-[500]'/>
        <p style={sales > 0 ? { color: "#3aff3a" } : { color: "red" }} className='text-lg place-self-end font-[500]'>{`${sales}%`}</p>
      </div>
