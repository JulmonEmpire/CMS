  ...
  return (
    <>
      ...
      <tr className="h-12 hover:!bg-[rgba(0,0,0,0.030)] cursor-pointer" onClick={() => { navigate("/patients-information", { state: { ...patient } }); }} key={patient?.id} style={index % 2 !== 0 ? { backgroundColor: "#EEEEEE" } : { backgroundColor: "#ffffff" }}>
        <td className='p-2 font-[500]'>{patient?.alert?<IoMdAlert title='The last date of consultation was added 6 years ago. Please take necessary action' className='w-[20px] text-[red] h-[20px] rounded-full'></IoMdAlert>:patient.id.slice(0, -2)}</td>
